...
const NotData = () => {
  return (
    <div className="not-data flex justify-center items-center flex-col">
      <svg
        width={113}
        height={114}
        viewBox="0 0 113 114"
      ...
      <h6 className="mt-7 text-xl">No Data</h6>
      <p className="mt-2">Your record will be synced here once it ready</p>
    </div>
  );
};
